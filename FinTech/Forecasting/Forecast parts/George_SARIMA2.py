...
cashed.plot(figsize=(20,10), linewidth=5, fontsize=20)
plt.xlabel('Year', fontsize=20)
plt.ylabel('Cashing units', fontsize=20)
...
ax = cashed['2015':].plot(label='observed')
pred.predicted_mean.plot(ax=ax, label='One-step ahead Forecast', alpha=0.7, figsize=(24, 14))
pred.predicted_mean
ax.set_xlabel('Date')
ax.set_ylabel('Cashed units')
plt.legend()
plt.show()
...
############# acccuracy parameters for (0, 0, 1),(1, 1, 1, 12),
...
ax = cashed.plot(label='observed', figsize=(14, 4))
